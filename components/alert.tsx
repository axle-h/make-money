...
export function UpToDate() {
  return (
    <LeftAccentAlert status="success">
      <Alert.Indicator />
          ...
          <Alert.Description>
            <Text>
              <Link href="/statements">
                Upload your latest statement for accounts:
              </Link>
      ...
      <LeftAccentAlert status="error" key="uncategorized-alert">
        ...
        <Box>
          ...
          <Alert.Description>
            ...
            <Link href="/uncategorized" textDecoration="underline">
              Approve uncategorized transactions.
            </Link>
          </Alert.Description>
        </Box>
      </LeftAccentAlert>

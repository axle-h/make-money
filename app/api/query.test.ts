...
describe('stringify', () => {
  ...
  it('dates', () => {
    const observed = stringifySearchParams({
      dt: new Date(2024, 0, 1, 12, 30, 0, 0),
    })
    expect(Object.fromEntries(observed)).toEqual({
      dt: '2024-01-01T12:30:00.000Z',
    })
  })
...
describe('parse', () => {
  ...
  it('array', () => {
    const observed = parseSearchParams(
      new URLSearchParams({ 'arr[0]': 'a', 'arr[1]': 'b' })
    )

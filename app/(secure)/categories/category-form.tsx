          ...
          <Form>
            <Stack gap={6}>
              ...
              <FormikField name="emoji">
                {({ field, form }: FieldProps<string, NewCategory>) => (
                  <Field.Root
                    invalid={!!form.errors.emoji && !!form.touched.emoji}
                  >
              ...
              <FormikField name="type">
                {({ field, form }: FieldProps<string, NewCategory>) => (
                  <Field.Root
                    invalid={!!form.errors.type && !!form.touched.type}
                    required
                  >
              ...
              <SimpleGrid columns={2}>
                <FormikField name="report">
                  {({ field }: FieldProps<string, NewCategory>) => (
                    <Switch.Root
                      defaultChecked={formInitialValues.report}
                      {...field}
                    >
                      <Switch.HiddenInput />
                      <Switch.Control />
                      <Switch.Label>Include in reports?</Switch.Label>
                    </Switch.Root>
                  )}
                </FormikField>
                ...
                <FormikField name="subCategory">
                  {({ field }: FieldProps<string, NewCategory>) => (
                    <Switch.Root
                      defaultChecked={formInitialValues.subCategory}
                      {...field}
                    >
                      <Switch.HiddenInput />
                      <Switch.Control />
                      <Switch.Label>Includes sub-category?</Switch.Label>
                    </Switch.Root>
                  )}
                </FormikField>
              </SimpleGrid>

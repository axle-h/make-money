...
import {CodeIcon, MoreVerticalIcon, AddIcon, CheckIcon, CloseIcon, PlusSquareIcon} from "@/components/icons";
                                                ...
                                                {values.categories.length < 2 ? <></> : (
                                                    <>
                                                        <Box flexShrink={1} mr={1}>
                                                            ...
                                                            <FormikField name={`categories[${index}].fraction`}>
                                                                {({ field }: FieldProps<string, UpdateTransactionRequest>) => (
                                                                    <NumberInput.Root
                                                                        step={0.1}
                                                                        ...
                                                                        {...field}
                                                                        onValueChange={(e) => setFieldValue(`categories[${index}].fraction`, e.valueAsNumber)}
                                                                    >
                                                                        <NumberInput.Input />
                                                                        <NumberInput.Control />
                                                                    </NumberInput.Root>
                                                        ...
                                                        : (
                                                            <List.Root>
                                                                {errors.categories.map((e, i) =>
                                                                    <List.Item key={`error-${i}`}>{e.toString()}</List.Item>)}
                                                            </List.Root>
                                                        )
                                                    : <></>
                                                }
                                    ...
                                    <Menu.Root>
                                        ...
                                        <Menu.Positioner>
                                            <Menu.Content>
                                                ...
                                                <Menu.Item value="create-new-category" onClick={onCreateNewCategory}>
